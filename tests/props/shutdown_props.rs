...
mod tests {
    ...
    #[test]
    fn test_manual_decrement_never_underflows() {
        let coord = ShutdownCoordinator::default();
    ...
    #[test]
    fn test_try_request_start_rejects_after_shutdown() {
        let coord = ShutdownCoordinator::default();
        coord.shutdown();

        let guard = coord.try_request_start();
    ...
    #[test]
    fn test_request_start_does_not_admit_work_after_shutdown() {
        let coord = ShutdownCoordinator::default();
        coord.shutdown();
    ...
    #[test]
    fn test_manual_increment_does_not_admit_work_after_shutdown() {
        let coord = ShutdownCoordinator::default();
        coord.shutdown();
